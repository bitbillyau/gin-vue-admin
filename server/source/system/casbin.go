...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/db/getSymbolsForLinkedLbankAccount", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/db/getLbankAccounts", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/db/submitLinkedLbankSubAccounts", V2: "POST"},
